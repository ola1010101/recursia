...
int main()
{
    ...
    std::cout << "введите день, мес€ц и год у первой даты \n";
    std::cin >> dey1;
    std::cin >> month1;
    std::cin >> year1;
    std::cout << "введите день, мес€ц и год у второй даты \n";
    std::cin >> dey2;
    std::cin >> month2;
    std::cin >> year2;
    std::cout << "разница в дн€х равна " << Dey(dey1, month1, year1, dey2, month2, year2) << "\n";
